j = Job(name='dsp_down_mm-dd:0') #"mm-dd:run"
...
bkPath = '/LHCb/Collision17/Beam6500GeV-VeloClosed-MagDown/Real Data/Turbo04/94000000/CHARMSPEC.MDST' #path to real data
...
j.outputfiles = [DiracFile('Dsp2KKpiMagDown1.root')] #change to magdown/magup
j.submit()

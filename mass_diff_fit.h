...
// Wed Mar 24 15:38:53 2021 by ROOT version 6.22/00
// from TTree DecayTree/DecayTree
// found on file: /share/lazy/D2KKpi/combined_cut.root
//////////////////////////////////////////////////////////

#ifndef mass_diff_fit_h
#define mass_diff_fit_h
...
class mass_diff_fit : public TSelector {
public :
   ...
   mass_diff_fit(TTree * /*tree*/ =0) { }
   virtual ~mass_diff_fit() { }
   ...
   ClassDef(mass_diff_fit,0);

};

#endif

#ifdef mass_diff_fit_cxx
void mass_diff_fit::Init(TTree *tree)
{

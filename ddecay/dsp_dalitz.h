...
// Mon Jul 13 23:04:54 2020 by ROOT version 6.18/00
...
class dsp_dalitz : public TSelector {
public :
   TTreeReader     fReader;  //!the tree reader
   TTree          *fChain = 0;   //!pointer to the analyzed TTree or TChain

   // Readers to access the data (delete the ones you do not need).
   TTreeReaderValue<Double_t> D_splus_ENDVERTEX_X = {fReader, "D_splus_ENDVERTEX_X"};
   TTreeReaderValue<Double_t> D_splus_ENDVERTEX_Y = {fReader, "D_splus_ENDVERTEX_Y"};
   TTreeReaderValue<Double_t> D_splus_ENDVERTEX_Z = {fReader, "D_splus_ENDVERTEX_Z"};
   TTreeReaderValue<Double_t> D_splus_ENDVERTEX_XERR = {fReader, "D_splus_ENDVERTEX_XERR"};
   TTreeReaderValue<Double_t> D_splus_ENDVERTEX_YERR = {fReader, "D_splus_ENDVERTEX_YERR"};
   TTreeReaderValue<Double_t> D_splus_ENDVERTEX_ZERR = {fReader, "D_splus_ENDVERTEX_ZERR"};
   TTreeReaderValue<Double_t> D_splus_ENDVERTEX_CHI2 = {fReader, "D_splus_ENDVERTEX_CHI2"};
   TTreeReaderValue<Int_t> D_splus_ENDVERTEX_NDOF = {fReader, "D_splus_ENDVERTEX_NDOF"};
   TTreeReaderValue<Double_t> D_splus_OWNPV_X = {fReader, "D_splus_OWNPV_X"};
   TTreeReaderValue<Double_t> D_splus_OWNPV_Y = {fReader, "D_splus_OWNPV_Y"};
   TTreeReaderValue<Double_t> D_splus_OWNPV_Z = {fReader, "D_splus_OWNPV_Z"};
   TTreeReaderValue<Double_t> D_splus_OWNPV_XERR = {fReader, "D_splus_OWNPV_XERR"};
   TTreeReaderValue<Double_t> D_splus_OWNPV_YERR = {fReader, "D_splus_OWNPV_YERR"};
   TTreeReaderValue<Double_t> D_splus_OWNPV_ZERR = {fReader, "D_splus_OWNPV_ZERR"};
   TTreeReaderValue<Double_t> D_splus_OWNPV_CHI2 = {fReader, "D_splus_OWNPV_CHI2"};
   TTreeReaderValue<Int_t> D_splus_OWNPV_NDOF = {fReader, "D_splus_OWNPV_NDOF"};
   TTreeReaderValue<Double_t> D_splus_IP_OWNPV = {fReader, "D_splus_IP_OWNPV"};
   TTreeReaderValue<Double_t> D_splus_IPCHI2_OWNPV = {fReader, "D_splus_IPCHI2_OWNPV"};
   TTreeReaderValue<Double_t> D_splus_FD_OWNPV = {fReader, "D_splus_FD_OWNPV"};
   TTreeReaderValue<Double_t> D_splus_FDCHI2_OWNPV = {fReader, "D_splus_FDCHI2_OWNPV"};
   TTreeReaderValue<Double_t> D_splus_DIRA_OWNPV = {fReader, "D_splus_DIRA_OWNPV"};
   TTreeReaderValue<Double_t> D_splus_P = {fReader, "D_splus_P"};
   TTreeReaderValue<Double_t> D_splus_PT = {fReader, "D_splus_PT"};
   TTreeReaderValue<Double_t> D_splus_PE = {fReader, "D_splus_PE"};
   TTreeReaderValue<Double_t> D_splus_PX = {fReader, "D_splus_PX"};
   TTreeReaderValue<Double_t> D_splus_PY = {fReader, "D_splus_PY"};
   TTreeReaderValue<Double_t> D_splus_PZ = {fReader, "D_splus_PZ"};
   TTreeReaderValue<Double_t> D_splus_MM = {fReader, "D_splus_MM"};
   TTreeReaderValue<Double_t> D_splus_MMERR = {fReader, "D_splus_MMERR"};
   TTreeReaderValue<Double_t> D_splus_M = {fReader, "D_splus_M"};
   TTreeReaderValue<Int_t> D_splus_ID = {fReader, "D_splus_ID"};
   ...
   ClassDef(dsp_dalitz,0);

};

#endif

#ifdef dsp_dalitz_cxx
void dsp_dalitz::Init(TTree *tree)
{

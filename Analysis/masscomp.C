...
double uczero[1] = {0};
	double ucmass[1] = {1869.82};
	double ucy[1] = {4};
	double ucstat[1] = {0.0226};
...
lt->DrawLatexNDC(0.41, 0.68, "#color[4]{1869.82 #pm 0.0226}");//UC
...
double uczero[1] = {0};
	double ucmass[1] = {1968.79};
	double ucy[1] = {5};
	double ucstat[1] = {0.0815};
...
lt->DrawLatexNDC(0.38, 0.72, "#color[4]{1968.79 #pm 0.0815}");//UC

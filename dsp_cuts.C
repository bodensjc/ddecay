...
pad1->SetBottomMargin(0);
 ...
 pad1->SetLogy(); //comment this out to have a non-log y scale for hist
...
auto lt = new TLatex();
lt->SetTextSize(0.03);
//0.62 and 0.57 for y values if non-log plot
lt->DrawLatexNDC(0.60, 0.35, "#mu ="+muStr+" #pm "+muStrpm+" MeV/c^{2}");
lt->DrawLatexNDC(0.60, 0.30, "Signal Events = "+nSignalStr+" #pm "+nSignalStrpm);

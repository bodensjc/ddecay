...
//************** Initialization Section ************
   ...
   kminusloghist = new TH1D("kminusloghist", "D^{+} #rightarrow K^{+}K^{-}#pi^{+},  #color[4]{K^{-}} (#color[2]{#pi^{+}}) log likelihood difference",80, -4, 12);
...
kminusloghist->SetTitleOffset(1.5);

...
//comes from share/lazy/Nov17Code/lhcb_correction/Trigger_DTF_10Feb/fit0p5MeV_GaussianPlusCBWithExp.c
   ...
   Double_t fit1MeV_DoubleGaussian_DoubleCB_ExpBG(Double_t *v, Double_t *par)
   {
...
//repeat above for second signal
      ...
      Double_t arg22 = 0;
      if (sigma22 != 0) arg22 = (v[0] - mu2)/sigma22;
...
//  add an exponential background
      fitval = fitval + par[14]*TMath::Exp(par[15]*(v[0]-1819.));
...
Double_t  firstSignal (Double_t *v, Double_t *par) 
{
...
Double_t  secondSignal (Double_t *v, Double_t *par) 
{

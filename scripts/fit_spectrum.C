...
//fitting where CB parameters are same for both peaks
//i left the second CB n and alpha here so I could be lazy in my analysis files (# params, etc.)


Double_t fit1MeVspectrum_Gaussian_sameCB_ExpBG(Double_t *v, Double_t *par) {

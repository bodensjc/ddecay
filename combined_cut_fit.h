...
// Thu Mar 11 12:19:43 2021 by ROOT version 6.22/00
// from TTree DecayTree/DecayTree
// found on file: /share/lazy/D2KKpi/combined_cut.root
//////////////////////////////////////////////////////////

#ifndef combined_cut_fit_h
#define combined_cut_fit_h
...
class combined_cut_fit : public TSelector {
public :
   ...
   combined_cut_fit(TTree * /*tree*/ =0) { }
   virtual ~combined_cut_fit() { }
   ...
   ClassDef(combined_cut_fit,0);

};

#endif

#ifdef combined_cut_fit_cxx
void combined_cut_fit::Init(TTree *tree)
{
...
Bool_t combined_cut_fit::Notify()
{
...
#endif // #ifdef combined_cut_fit_cxx
